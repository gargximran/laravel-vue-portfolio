    ...
    data: () => ({
        skills: [
            ...
            },
            {
                ...
                name: "Vuetify",
                desc:
                    "Vuetify is a reusable semantic component framework for Vue. js that aims to provide clean, semantic and reusable components. It supports all the modern browsers."
            },
            {
                color: "#70a660",
                name: "NodeJs",
